                                ...
                                Select Case selectedData.Symbols(3).Trim
                                    ...
                                    Case "AC220V", "AC230V", "AC240V"
                                        ...
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                   ...
                                                                                   selectedData.Symbols(1).Trim & MyControlChars.Hyphen & "1"
                                        decOpAmount(UBound(decOpAmount)) = 1
                                    Case "AC380V", "AC400V", "AC415V", "AC440V", "AC460V", "AC480V"
                                        ...
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                   strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & _
                                                                                   selectedData.Symbols(1).Trim & MyControlChars.Hyphen & "2"
                                        decOpAmount(UBound(decOpAmount)) = 1
                                End Select
                        End Select
                    Next
                                ...
                                Case "N1", "Y2"
                                    Select Case selectedData.Symbols(1).Trim
                                        Case "055", "075", "095", "120"
                                            ...
                                            ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                            strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                       strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & "1"
                                            decOpAmount(UBound(decOpAmount)) = 1
                                        Case "150D", "200D", "250D"
                                            ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                            ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                            strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                       strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & "2"
                                            decOpAmount(UBound(decOpAmount)) = 1
                                        Case "300D", "400D", "480D"
                                            ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                            ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                            strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                       strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & "3"
                                            decOpAmount(UBound(decOpAmount)) = 1
                                    End Select
                                Case "O"
                                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                ...
                                Case "N1", "Y2"
                                    Select Case selectedData.Symbols(1).Trim
                                        ...
                                        Case "710", "960"
                                            ...
                                            strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & _
                                                                                       selectedData.Symbols(2).Trim & MyControlChars.Hyphen & _
                                                                                       strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & "4"
                                            decOpAmount(UBound(decOpAmount)) = 1
                                    End Select
                                Case "O"
                                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
