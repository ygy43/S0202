...
Module KHPrice05
    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            intMaxOption = UBound(selectedData.Symbols.ToArray())
                ...
                Case Else
                    ...
                    Select Case selectedData.Series.series_kataban.Trim
                        Case "GX"
                            ...
                            If selectedData.Series.key_kataban = "A" Or _
                               selectedData.Series.key_kataban = "B" Then
                                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                strOpRefKataban(UBound(strOpRefKataban)) = "GX" & selectedData.Symbols(1) & _
                                                                                  selectedData.Symbols(2) & _
                                                                                  MyControlChars.Hyphen & _
                        ...
                        Case "GK"
                            ...
                            'strOpRefKataban(UBound(strOpRefKataban)) = "GK" & selectedData.Symbols(1) & _
                            '                                                  selectedData.Symbols(2) & _
                            '                                                  MyControlChars.Hyphen & _
                            '                                                  selectedData.Symbols(4)
