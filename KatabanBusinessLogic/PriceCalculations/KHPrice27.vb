                            ...
                            Case Else
                                ...
                                Select Case selectedData.Symbols(4).Trim
                                    Case "T0H", "T0V", "T2H", "T2V", "T3H", "T3V", "T5H", "T5V", "T1H", "T1V", "T8H", "T8V", _
                                        ...
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(5).Trim & "(2)"
                                    Case "T2YFH", "T2YFV", "T3YFH", "T3YFV", "T2YMH", "T2YMV", "T3YMH", "T3YMV"
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(5).Trim & "(3)"
                                    Case "T2JH", "T2JV"
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(5).Trim & "(4)"
                                    Case Else
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(5).Trim
                                End Select
                            ...
                            Case Else
                                ...
                                Select Case selectedData.Symbols(5).Trim
                                    Case "T0H", "T0V", "T2H", "T2V", "T3H", "T3V", "T5H", "T5V", "T1H", "T1V", "T8H", "T8V", _
                                         "T2WH", "T2WV", "T3WH", "T3WV", "T2YH", "T2YV", "T3YH", "T3YV", "T3PH", "T3PV"
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(6).Trim & "(2)"
                                    Case "T2YFH", "T2YFV", "T3YFH", "T3YFV", "T2YMH", "T2YMV", "T3YMH", "T3YMV"
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(6).Trim & "(3)"
                                    Case "T2JH", "T2JV"
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(6).Trim & "(4)"
                                    Case Else
                                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                                   selectedData.Symbols(6).Trim
                                End Select
                ...
                Select Case strOpArray(intLoopCnt).Trim
                    ...
                    Case "J", "L"
                        ...
                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                   ...
                                                                   "20" & MyControlChars.Hyphen & intStroke.ToString
                        decOpAmount(UBound(decOpAmount)) = 1
                    Case "M"
                        Select Case selectedData.Symbols(2).Trim
                            ...
                            Case Else
                                ...
                                strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 4) & _
                                                                           strOpArray(intLoopCnt).Trim & MyControlChars.Hyphen & _
                                                                           "40" & MyControlChars.Hyphen & intStroke.ToString
                                decOpAmount(UBound(decOpAmount)) = 1
                        End Select
                    Case "P"
                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
