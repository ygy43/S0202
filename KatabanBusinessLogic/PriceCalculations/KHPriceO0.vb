...
Module KHPriceO0
    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            Select Case Mid(selectedData.Series.series_kataban, 1, 3)
                '2012/02/17 変更
                Case "LCG"
                    'オプション加算価格キー
            ...
            Select Case Mid(selectedData.Series.series_kataban, 1, 3)
                Case "LCX"
                    If selectedData.Symbols(2).Trim.Length <> 0 Then
                ...
                Case "LCV"
                    ...
                    ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 3) & MyControlChars.Hyphen & _
                                                               selectedData.Series.key_kataban & MyControlChars.Hyphen & _
                                                               selectedData.Symbols(1).Trim & MyControlChars.Hyphen & _
                                                               intStroke.ToString
                    decOpAmount(UBound(decOpAmount)) = 1
                    ...
                    If selectedData.Series.key_kataban = "P" Then
                        ...
                        strOpRefKataban(UBound(strOpRefKataban)) = Left(selectedData.Series.series_kataban.Trim, 3) & MyControlChars.Hyphen & _
                                                                   selectedData.Series.key_kataban & MyControlChars.Hyphen & _
                                                                   selectedData.Symbols(1).Trim & MyControlChars.Hyphen & _
                                                                   intStroke.ToString & MyControlChars.Hyphen & _
            ...
            'RM1712027_LCV追加
            If Mid(selectedData.Series.series_kataban, 1, 3) = "LCV" Then
                'スイッチ加算価格キー
