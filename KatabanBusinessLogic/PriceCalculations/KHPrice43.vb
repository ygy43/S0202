    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
                ...
                Select Case Left(selectedData.Symbols(1).Trim, 1)
                    Case "M", "J"
                        ...
                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban & MyControlChars.Hyphen & _
                                                                   Mid(selectedData.Symbols(1).Trim, 2) & MyControlChars.Hyphen & _
            ...
            If selectedData.Symbols(1).IndexOf("M") >= 0 Or _
               selectedData.Symbols(1).IndexOf("J") >= 0 Then
                Select Case Left(selectedData.Symbols(1).Trim, 1)
                    Case "M"
                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                        ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)     'RM0908030 2009/10/30 Y.Miura
                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban & MyControlChars.Hyphen & "M" & MyControlChars.Hyphen & _
                    ...
                    Case "J"
                        ...
                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                        ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)     'RM0908030 2009/10/30 Y.Miura
                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban & MyControlChars.Hyphen & "J" & MyControlChars.Hyphen & _
                                                                   selectedData.Symbols(2).Trim
                        decOpAmount(UBound(decOpAmount)) = 1
                        'RM0908030 2009/10/30 Y.Miura
                        If bolC5Flag = True Then
            ...
            If selectedData.Symbols(4).Trim <> "" Then
                ...
                If strOptionP4 <> "" Then
                    ...
                    ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                    ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)     'RM0908030 2009/10/30 Y.Miura
                    strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban & "-SW-P4"
                    decOpAmount(UBound(decOpAmount)) = KatabanUtility.SwitchQtyGet(selectedData.Symbols(6).Trim)
                End If
            ...
            For intLoopCnt = 0 To strOpArray.Length - 1
                Select Case strOpArray(intLoopCnt).Trim
                    ...
                    Case "P4", "P40"
                        ...
                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                        ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)     'RM0908030 2009/10/30 Y.Miura
                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban & "-OP-" & _
