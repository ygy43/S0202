...
Module KHPriceF7
    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            strOpRefKataban(UBound(strOpRefKataban)) = "HRL-2S-" & selectedData.Symbols(3).Trim & MyControlChars.Hyphen & intXZStroke.ToString
            ...
            If selectedData.Symbols(7).Trim <> "" Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = "HRL-2S-" & selectedData.Symbols(7).Trim
                decOpAmount(UBound(decOpAmount)) = 1
                ...
                If selectedData.Symbols(8).Trim <> "" Then
                    ...
                    'ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                    'ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                    'strOpRefKataban(UBound(strOpRefKataban)) = "HRL-2S-" & selectedData.Symbols(8).Trim
                    'decOpAmount(UBound(decOpAmount)) = 1
            ...
            If selectedData.Symbols(6).Trim <> "" Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = "HRL-2S-" & selectedData.Symbols(6).Trim
                decOpAmount(UBound(decOpAmount)) = 1
            End If
