    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            If UBound(selectedData.Symbols.ToArray()) >= 5 Then
                If selectedData.Symbols(5).Trim = "P74" Then
                    strOptionP7 = "P74"
                End If
            End If
            If strOptionP7 = "P74" Then
                ...
                strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                           ...
                                                           "W" & MyControlChars.Hyphen & selectedData.Symbols(5).Trim
                ...
                For intLoopCnt = 0 To strOpArray.Length - 1
                    Select Case strOpArray(intLoopCnt).Trim
                        ...
                        Case Else
                            ...
                            ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                            strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                       "W" & MyControlChars.Hyphen & strOpArray(intLoopCnt).Trim
                            decOpAmount(UBound(decOpAmount)) = 1
                    End Select
                Next
            Else
                ...
                Select Case selectedData.Series.series_kataban.Trim
                    ...
                    Case "C1000", "C2000", "C2500", "C3000", "C4000", "C8000", "C6500"
                        ...
                        If bolOptionF = True Then
                            ...
                            If selectedData.Series.series_kataban.Trim = "C2000" And bolOptionF1 Then
                        ...
                        Else
                            If bolOptionFF = True Then
                                strOpRefKataban(UBound(strOpRefKataban)) = strOpRefKataban(UBound(strOpRefKataban)) & MyControlChars.Hyphen & "FF"
                        ...
                        Select Case selectedData.Series.key_kataban
                            Case "X"
                                ...
                                If Len(selectedData.Symbols(4).Trim) <> 0 Then
                                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                    strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                               "W" & MyControlChars.Hyphen & selectedData.Symbols(4).Trim
                                    ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                    decOpAmount(UBound(decOpAmount)) = 1
                                End If
                        End Select
                    ...
                    Case "MX3000", "MX4000", "MX1000", "MX8000", "MX6000"
                        ...
                        Select Case selectedData.Series.key_kataban
                            ...
                            Case Else
                                ...
                                If Len(selectedData.Symbols(4).Trim) <> 0 Then
                                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                    strOpRefKataban(UBound(strOpRefKataban)) = strOpRefKataban(UBound(strOpRefKataban)) & MyControlChars.Hyphen & "J1"
                                    ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                    decOpAmount(UBound(decOpAmount)) = 1
                                End If
                        End Select
                    ...
                    Case "R2000", "R2100"
                        ...
                        If selectedData.Symbols(4).Trim = "J1" Then
                            strOpRefKataban(UBound(strOpRefKataban)) = strOpRefKataban(UBound(strOpRefKataban)) & MyControlChars.Hyphen & "J1"
                        End If
                            ...
                            For intLoopCnt = 0 To strOpArray.Length - 1
                                Select Case strOpArray(intLoopCnt).Trim
                                    ...
                                    Case Else
                                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & "15W" & MyControlChars.Hyphen & _
                            ...
                            For intLoopCnt = 0 To strOpArray.Length - 1
                                Select Case strOpArray(intLoopCnt).Trim
                                    ...
                                    Case Else
                                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & "W" & MyControlChars.Hyphen & _
                                                                                   strOpArray(intLoopCnt).Trim
                                        decOpAmount(UBound(decOpAmount)) = 1
                                End Select
                            Next
                            ...
                            Select Case selectedData.Series.series_kataban.Trim
                                Case "C4020", "C4030"
                                    If (selectedData.Symbols(1).Trim = "20" Or _
                                                                   ...
                                                                   (InStr(selectedData.Symbols(5).Trim, "S") <> 0) Then
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                   "W" & MyControlChars.Hyphen & "20" & MyControlChars.Hyphen
                                    Else
                                        strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                                   "W" & MyControlChars.Hyphen
                                    End If
                                Case Else
                                    strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & MyControlChars.Hyphen & _
                                                                               "W" & MyControlChars.Hyphen
