    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            If selectedData.Symbols(4).Trim = "R1" Then
                Select Case Right(selectedData.Symbols(2).Trim, 1)
                    Case "G", "N"
                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                        ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                        'Del by Zxjike 2013/10/03
                        'strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V-" & _
                        '                                                 Left(selectedData.Symbols(2).Trim, 2)
                        'Add by Zxjike 2013/10/03
                        strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V-" & _
                                                                         Left(selectedData.Symbols(2).Trim, 2) & _
                                                                         Right(selectedData.Symbols(2).Trim, 1)
                        decOpAmount(UBound(decOpAmount)) = CDec(selectedData.Symbols(7).Trim)

                        'ねじ加算数量
                        'intScrewQty = intScrewQty + CDec(selectedData.Symbols(7).Trim) Del by Zxjike 2013/10/03
                    Case Else
                        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                        ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                    ...
                    Case "1", "5"
                        Select Case Right(selectedData.Symbols(2).Trim, 1)
                            Case "G", "N"
                                ...
                                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                                'Del by Zxjike 2013/10/03
                                'strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V1-" & _
                                '                                                 Left(selectedData.Symbols(2).Trim, 2)
                                strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V1-" & _
                                                 Left(selectedData.Symbols(2).Trim, 2) & _
                                                 Right(selectedData.Symbols(2).Trim, 1)
                                ...
                                'ねじ加算数量
                                'Del by Zxjike 2013/10/03
                                'intScrewQty = intScrewQty + CDec(selectedData.Symbols(7).Trim) 
                            Case Else
                                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                    ...
                    Case Else
                        Select Case Right(selectedData.Symbols(2).Trim, 1)
                            Case "G", "N"
                                ...
                                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                                'Del by Zxjike 2013/10/03
                                'strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V2-" & _
                                '                                                 Left(selectedData.Symbols(2).Trim, 2)
                                strOpRefKataban(UBound(strOpRefKataban)) = "N" & Mid(selectedData.Series.series_kataban.Trim, 2, 5) & "-V2-" & _
                                                 Left(selectedData.Symbols(2).Trim, 2) & _
                                                 Right(selectedData.Symbols(2).Trim, 1)
            ...
            If selectedData.Symbols(4).Trim <> "R1" Then
                ...
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = "NW4G4-" & selectedData.Symbols(4).Trim
            ...
            Select Case Right(selectedData.Symbols(2).Trim, 1)
                Case "G", "N"
                    strOptionGN = Right(selectedData.Symbols(2).Trim, 1)
            End Select

            'エンドブロック
            If InStr(selectedData.Symbols(3).Trim, "XU") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                End If
            ElseIf InStr(selectedData.Symbols(3).Trim, "XD") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                If strOptionGN.Trim <> "" Then
                    intScrewQty = intScrewQty + 2
                End If
            ElseIf InStr(selectedData.Symbols(3).Trim, "CU") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                If strOptionGN.Trim <> "" Then
                    intScrewQty = intScrewQty + 2
                End If
            ElseIf InStr(selectedData.Symbols(3).Trim, "CD") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                If strOptionGN.Trim <> "" Then
                    intScrewQty = intScrewQty + 2
                End If
            ElseIf InStr(selectedData.Symbols(3).Trim, "EU") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                If strOptionGN.Trim <> "" Then
                    intScrewQty = intScrewQty + 2
                End If
            ElseIf InStr(selectedData.Symbols(3).Trim, "ED") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                ...
                If strOptionGN.Trim <> "" Then
                    intScrewQty = intScrewQty + 2
                End If
            ElseIf InStr(selectedData.Symbols(6).Trim, "K") <> 0 Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
