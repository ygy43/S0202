    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            If (selectedData.Symbols(8).Trim <> "") Then
                ...
                strOpRefKataban(UBound(strOpRefKataban)) = _
                    Left(selectedData.Series.series_kataban.Trim, 4) & _
                    MyControlChars.Hyphen & "N" & MyControlChars.Hyphen & _
            ...
            If selectedData.Symbols(4).Trim.Length <> 0 Then
                ...
                If selectedData.Symbols(7).Trim.Length <> 0 Then
                    ...
                    ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = _
                        Left(selectedData.Series.series_kataban.Trim, 4) & MyControlChars.Hyphen & _
                ...
                If selectedData.Symbols(5).Trim.Length <> 0 Then
                    ...
                    If selectedData.Symbols(4).Trim = "T2YD" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                        Left(selectedData.Series.series_kataban.Trim, 4) & _
                        MyControlChars.Hyphen & "N" & MyControlChars.Hyphen & "T2YD" & MyControlChars.Hyphen & _
                        selectedData.Symbols(5).Trim

                    ElseIf selectedData.Symbols(4).Trim = "T2YDT" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(selectedData.Series.series_kataban.Trim, 4) & _
                         MyControlChars.Hyphen & "N" & MyControlChars.Hyphen & "T2YDT" & MyControlChars.Hyphen & _
                         selectedData.Symbols(5).Trim

                    ElseIf selectedData.Symbols(4).Trim = "T2JH" Or _
                    selectedData.Symbols(5).Trim = "T2JV" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(selectedData.Series.series_kataban.Trim, 4) & _
                         MyControlChars.Hyphen & "N" & MyControlChars.Hyphen & "T2J" & MyControlChars.Hyphen & _
                         selectedData.Symbols(5).Trim
                    Else
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(selectedData.Series.series_kataban.Trim, 4) & _
                         MyControlChars.Hyphen & "N" & MyControlChars.Hyphen & "T" & MyControlChars.Hyphen & _
                         selectedData.Symbols(5).Trim
                    End If
