    ...
    Public Sub subPriceCalculation(selectedData As SelectedInfo, _
        ...
        Try
            ...
            If selectedData.Symbols(5).Trim = "" Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = selectedData.Series.series_kataban.Trim & "-MINUS-L"
                decOpAmount(UBound(decOpAmount)) = intQuantity
            End If
            ...
            If selectedData.Symbols(6).Trim <> "" Then
                ...
                '電線接続が"R"(VAコネクタ(防滴))
                If selectedData.Symbols(6).Trim = "R" Then
                    decOpAmount(UBound(decOpAmount)) = 1
                Else
                    decOpAmount(UBound(decOpAmount)) = intQuantity
                End If
