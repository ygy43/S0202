...
'            strOpRefKataban(UBound(strOpRefKataban)) = "HRL-3A-" & selectedData.Symbols(3).Trim & MyControlChars.Hyphen & intRZStroke.ToString
...
'                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
'                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
'                strOpRefKataban(UBound(strOpRefKataban)) = "HRL-3A-" & selectedData.Symbols(7).Trim
'                decOpAmount(UBound(decOpAmount)) = 1
...
'                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
'                    ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
'                    strOpRefKataban(UBound(strOpRefKataban)) = "HRL-3A-" & selectedData.Symbols(8).Trim
'                    decOpAmount(UBound(decOpAmount)) = 1
'                End If
'            End If
...
'                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
'                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
'                strOpRefKataban(UBound(strOpRefKataban)) = "HRL-3A-" & selectedData.Symbols(6).Trim
'                decOpAmount(UBound(decOpAmount)) = 1
'            End If
