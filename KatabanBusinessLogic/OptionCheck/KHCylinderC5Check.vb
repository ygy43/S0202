...
Module KHCylinderC5Check
    ...
    '********************************************************************************************
    Public Function fncCylinderC5Check(selectedData As SelectedInfo,
        ...
        Try
            ...
            Select Case selectedData.Series.series_kataban.Trim
                ...
                'Case "CAC3"
                Case "CAC3", "CAC4"
                    If fncCAC3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                    'RM0811133 2009/08/01 Y.Miura
                Case "UCAC2", "UCAC2-L2"
                    If fncUCAC2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "CMK2"
                    If fncCMK2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "JSC3"
                    If fncJSC3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                    'RM1302XXX 2013/02/04 Y.Tachi
                Case "JSC4"
                    If fncJSC4C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "JSG", "JSG-V"
                    If fncJSGC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SCA2"
                    If fncSCA2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SCG", "SCG-D", "SCG-G", "SCG-G2", "SCG-G3", _
                     "SCG-G4", "SCG-M", "SCG-O", "SCG-Q", "SCG-U"
                    If fncSCGC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SCM"
                    If fncSCMC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SCS"
                    If fncSCSC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                    'RM1302XXX 2013/02/04 Y.Tachi
                Case "SCS2"
                    If fncSCS2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SSD"
                    If fncSSDC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "STG-B", "STG-M", "STG-K"
                    If fncSTGC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "STL-B", "STL-M", "STS-B", "STS-M"
                    If fncSTSC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "LCG", "LCG-Q"
                    If fncLCGC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "LCR", "LCR-Q" 'RM10030086 2010/04/07 Y.Miura 追加
                    If fncLCRC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SSG"
                    If fncSSGC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "JSK2", "JSK2-V"
                    If fncJSK2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SRL3"
                    If fncSRL3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SSD2"
                    If fncSSD2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SRT3" 'RM0811134:SRT3
                    If fncSRT3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "SRG3" 'RM0811134:SRG3
                    If fncSRG3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                ...
                Case "MDC2-L", "MDC2-XL", "MDC2-YL", "MSD-L", "MSD-KL", "MSD-XL", "MSD-YL", "MSDG-L", _
                    ...
                    If selectedData.Symbols(4).Trim = "F3PH" Or _
                        selectedData.Symbols(4).Trim = "F3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "LCT", "LCX", "LCX-Q"
                    If selectedData.Symbols(4).Trim = "T3PH" Or _
                        selectedData.Symbols(4).Trim = "T3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "LSH"
                    'RM1705004 2017/05/11 削除
                    'If selectedData.Series.key_kataban <> "1" And _
                    '    selectedData.Symbols(5).Trim = "C" Then
                    '    fncCylinderC5Check = True
                    'End If
                    If selectedData.Series.key_kataban <> "1" And _
                        (selectedData.Symbols(2).Trim = "F3PH" Or _
                        selectedData.Symbols(2).Trim = "F3PV") Then
                        fncCylinderC5Check = True
                    End If
                Case "CKV2", "CKV2-M"
                    If selectedData.Symbols(6).Trim = "T3PH" Or _
                        selectedData.Symbols(6).Trim = "T3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "RCC2", "RCC2-G4", "RCS"
                    If selectedData.Symbols(5).Trim = "T3PH" Or _
                        selectedData.Symbols(5).Trim = "T3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "RCS2"   'RM1803075_RCS2 追加
                    If selectedData.Symbols(6).Trim = "T3PH" Or _
                        selectedData.Symbols(6).Trim = "T3PV" Or _
                        selectedData.Symbols(6).Trim = "F3PH" Or _
                        selectedData.Symbols(6).Trim = "F3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "CAV2", "COVP2", "COVN2"
                    If selectedData.Symbols(7).Trim = "T3PH" Or _
                        selectedData.Symbols(7).Trim = "T3PV" Then
                        fncCylinderC5Check = True
                    End If
                    ...
                    End If
                Case "MVC"
                    If selectedData.Symbols(3).Trim = "F3PH" Or _
                        selectedData.Symbols(3).Trim = "F3PV" Then
                        fncCylinderC5Check = True
                    End If
                ...
                Case "SMG"
                    ...
                    '    '二次電池機種のみ 
                    '    If selectedData.Symbols.Length >= "9" Then
                    '        If fncLiIonC5Check(objKtbnStrc, 8, bolJudgeDiv) = True Then
                    '            fncCylinderC5Check = True
                    '        End If
                    '    End If
                ...
                Case "LHAG"
                    ...
                    If selectedData.Symbols.Count >= "7" Then
                        If fncLiIonC5Check(selectedData, 6, bolJudgeDiv) = True Then
                            fncCylinderC5Check = True
                        End If
                    End If
                    'RM1306001 2013/06/06
                    If selectedData.Symbols(6).Trim = "SX" Then
                        fncCylinderC5Check = True
                    End If
                    'RM0908030 2009/10/19 Y.Miura　二次電池対応
                Case "HMD"
                    If selectedData.Symbols.Count >= "6" Then
                        If fncLiIonC5Check(selectedData, 5, bolJudgeDiv) = True Then
                            fncCylinderC5Check = True
                        End If
                    End If
                    'RM1001043 2010/02/12 Y.Miura 二次電池C5加算廃止
                    ...
                    '    '二次電池機種のみ 
                    '    If selectedData.Symbols.Length >= "8" Then
                    '        If fncLiIonC5Check(objKtbnStrc, 7, bolJudgeDiv) = True Then
                    '            fncCylinderC5Check = True
                    '        End If
                    '    End If
                Case "HMF", "CKG", "BHE", "BHA"
                    ...
                    If selectedData.Symbols.Count >= "8" Then
                        If fncLiIonC5Check(selectedData, 7, bolJudgeDiv, True) = True Then
                            fncCylinderC5Check = True
                        End If
                    End If
                ...
                Case "FCD", "FCS", "FCH", "FCD-L", "FCS-L", "FCH-L", "FCD-D", "FCD-DL", "FCD-K", "FCD-KL"
                    ...
                    If selectedData.Symbols(2).Trim.Trim = "N" Or _
                        selectedData.Symbols(2).Trim.Trim = "G" Then
                        fncCylinderC5Check = True
                    End If
                Case "FK"
                    'fncCylinderC5Check = True
                    'RM1306005 2013/06/04 追加
                    If selectedData.Symbols(2).Trim = "SX" Then
                        fncCylinderC5Check = True
                    End If
                Case "HLD"
                    'fncCylinderC5Check = True                                   'Del by Zxjike 2013/10/01
                    If selectedData.Series.key_kataban.Trim = "2" Then   'Add by Zxjike 2013/10/01
                        fncCylinderC5Check = True
                    End If
                ...
                Case "MRL2", "MRL2-G", "MRL2-W"
                    ...
                    If fncMRL2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "MRL2-L", "MRL2-GL", "MRL2-WL"
                    ...
                    End If
                Case "MRG2"
                    If selectedData.Symbols(3).Trim = "T3PH" Or _
                        selectedData.Symbols(3).Trim = "T3PV" Then
                        fncCylinderC5Check = True
                    End If
                Case "SRM3"
                    'RM1306001 2013/06/04 追加 
                    If fncSRM3C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "UCA2", "UCA2-B", "UCA2-BL", "UCA2-L"
                    'RM1306001 2013/06/04 追加 
                    If fncUCA2C5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                ...
                Case "NCK"
                    'RM1306001 2013/06/04 追加 
                    If fncNCKC5Check(selectedData, bolJudgeDiv) = True Then
                        fncCylinderC5Check = True
                    End If
                Case "FJ"
                    'RM1306001 2013/06/04 追加
                    If selectedData.Symbols(4) = "SX" Then
                        fncCylinderC5Check = True
                    End If
                ...
                Case "HHC", "HHD", "CKT", "CKU", "HLF"
                    fncCylinderC5Check = True
                Case "LHA"
                    If selectedData.Series.key_kataban.Trim = "L" Then
                        fncCylinderC5Check = True
                    End If
                Case "3GA1", "3GA2", _
                     "4GA1", "4GA2", _
                    ...
                    If selectedData.Series.key_kataban.Trim = "S" Then
                        Select Case selectedData.Symbols(1).Trim
                            Case "66", "67", "76", "77"
                                fncCylinderC5Check = True
                        End Select
                        If selectedData.Symbols(7).Trim.Contains("M") Then
                            fncCylinderC5Check = True
                        End If
                    End If
                Case "M3GA1", "M3GA2", _
                     ...
                     "M3GB1", "M3GB2", _
                     "M4GB1", "M4GB2"
                    If selectedData.Series.key_kataban.Trim = "S" _
                        Or selectedData.Series.key_kataban.Trim = "V" Then
                        Select Case selectedData.Symbols(1).Trim
                            Case "66", "67", "76", "77", "8"
                                fncCylinderC5Check = True
                        End Select
    ...
    '********************************************************************************************
    Private Function fncCAC3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Series.key_kataban
                Case "R", "S"
                    If selectedData.Symbols(15).Trim = "S040" Or _
                selectedData.Symbols(15).Trim = "S050" Then
                        fncCAC3C5Check = False
                    End If
            End Select
    ...
    '********************************************************************************************
    Private Function fncCMK2C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
            ...
            Select Case selectedData.Series.key_kataban.Trim
                ...
                Case "", "4", "5"
                    ...
                    Select Case selectedData.Symbols(2).Trim
                        ...
                        Case "CC1"
                            'QまたはZを含む場合
                            If selectedData.Symbols(1).IndexOf("Q") >= 0 Or _
                               selectedData.Symbols(1).IndexOf("Z") >= 0 Then
                                fncCMK2C5Check = True
                            End If
                    End Select
                    ...
                    'オプション(食品製造工程向け商品)
                    If selectedData.Symbols(16).Trim = "FP1" Then
                        fncCMK2C5Check = True
                    End If
                    ...
                    If selectedData.Series.key_kataban.Trim = "" Then
                        If selectedData.Symbols(17).Trim = "SX" Then
                            fncCMK2C5Check = True
                        End If
                    End If
                ...
                Case "D", "E"
                    'バリエーション判定
                    If selectedData.Symbols(1).Trim <> "D" Then
                        fncCMK2C5Check = True
                    End If
                    ...
                    'オプション(食品製造工程向け商品)
                    If selectedData.Symbols(11).Trim = "FP1" Then
                        fncCMK2C5Check = True
                    End If
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncJSC3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Symbols(5).Trim
                Case "40", "50", "63"
                    If CInt(selectedData.Symbols(8).Trim) > 600 Then
                        fncJSC3C5Check = True
                    End If
                Case "80"
                    If CInt(selectedData.Symbols(8).Trim) > 700 Then
                        fncJSC3C5Check = True
                    End If
                Case "100"
                    If CInt(selectedData.Symbols(8).Trim) > 800 Then
                        fncJSC3C5Check = True
                    End If
                Case "125", "140", "160"
                    If CInt(selectedData.Symbols(8).Trim) > 800 Then
                    ...
                    End If
                Case "180"
                    If CInt(selectedData.Symbols(8).Trim) > 900 Then
                        fncJSC3C5Check = True
                    End If
            End Select

            'オプション判定
            If selectedData.Symbols(13).IndexOf("A2") >= 0 Or _
               selectedData.Symbols(13).IndexOf("P12") >= 0 Then
                fncJSC3C5Check = True
            End If
            ...
            Select Case selectedData.Series.key_kataban
                Case "R", "S"
                    If selectedData.Symbols(16).Trim = "S040" Or _
                selectedData.Symbols(16).Trim = "S050" Then
                        fncJSC3C5Check = False
                    End If
            End Select
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncJSC4C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            'オプション判定
            If InStr(selectedData.Symbols(13), "A2") <> 0 Then
                fncJSC4C5Check = True
            End If
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncJSGC5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Symbols(2).Trim
                Case "40", "50", "63"
                    If CInt(selectedData.Symbols(5).Trim) > 600 Then
                        fncJSGC5Check = True
                    End If
                Case "80"
                    If CInt(selectedData.Symbols(5).Trim) > 700 Then
                        fncJSGC5Check = True
                    End If
                Case "100"
                    If CInt(selectedData.Symbols(5).Trim) > 800 Then
                        fncJSGC5Check = True
                    End If
            End Select
            ...
            If bolJudgeDiv Then
                If selectedData.Symbols(7).Trim = "T2YDPU" Or _
                selectedData.Symbols(7).Trim = "T3PH" Or _
                selectedData.Symbols(7).Trim = "T3PV" Then
                    fncJSGC5Check = True
                End If
            End If
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncSCA2C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        Dim strOpArray() As String
        Dim intLoopCnt As Integer
        ...
        Try
            ...
            Select Case selectedData.Series.key_kataban.Trim
                Case "", "2"
                    ...
                    For intLoopCnt = 0 To strOpArray.Length - 1
                        Select Case strOpArray(intLoopCnt).Trim
                            ...
                            Case "J", "L"
                                ...
                                End If
                            Case "M"
                                If selectedData.Symbols(1).IndexOf("T1") >= 0 Or _
                                   selectedData.Symbols(1).IndexOf("T2") >= 0 Or _
                                   selectedData.Symbols(1).IndexOf("G1") >= 0 Or _
                                   selectedData.Symbols(1).IndexOf("G4") >= 0 Then
                                    fncSCA2C5Check = True
                                End If
                            Case "P6"
                    ...
                    'ロッド先端特注判定
                    If selectedData.RodEnd.RodEndOption <> "" Then
                        fncSCA2C5Check = True
                    End If
                    ...
                    If bolJudgeDiv Then
                        If selectedData.Symbols(10).Trim = "T2YDU" Or _
                        selectedData.Symbols(10).Trim = "T3PH" Or _
                        selectedData.Symbols(10).Trim = "T3PV" Then
                            fncSCA2C5Check = True
                        End If
                    End If

                    'オプション(食品製造工程向け商品)
                    If selectedData.Symbols(14).Trim = "FP1" Then
                        fncSCA2C5Check = True
                    End If
                ...
                Case "B", "C"
                    ...
                    ' T2YDUスイッチの場合はC5(ただし販促価格)
                    If bolJudgeDiv Then
                        If selectedData.Symbols(8).Trim = "T2YDU" Or _
                           selectedData.Symbols(14).Trim = "T2YDU" Or _
                           selectedData.Symbols(8).Trim = "T3PH" Or _
                           selectedData.Symbols(14).Trim = "T3PH" Or _
                           selectedData.Symbols(8).Trim = "T3PV" Or _
                           selectedData.Symbols(14).Trim = "T3PV" Then
                            fncSCA2C5Check = True
                        End If
                    End If

                    'オプション(食品製造工程向け商品)
                    If selectedData.Symbols(18).Trim = "FP1" Then
                        fncSCA2C5Check = True
                    End If
                ...
                Case "D", "E"
                    ...
                    ' T2YDUスイッチの場合はC5(ただし販促価格)
                    If bolJudgeDiv Then
                        If selectedData.Symbols(9).Trim = "T2YDU" Or _
                        selectedData.Symbols(9).Trim = "T3PH" Or _
                        selectedData.Symbols(9).Trim = "T3PV" Then
                            fncSCA2C5Check = True
                        End If
                    End If

                    'オプション(食品製造工程向け商品)
                    If selectedData.Symbols(13).Trim = "FP1" Then
                        fncSCA2C5Check = True
                    End If
            ...
            Select Case selectedData.Symbols(4).Trim
                Case "40", "50", "63"
                    If CInt(selectedData.Symbols(7).Trim) > 600 Then
                        fncSCA2C5Check = True
                    End If

                    'バリエーション「B」を含む場合はS2もチェック
                    If selectedData.Symbols(1).IndexOf("B") >= 0 Then
                        If CInt(selectedData.Symbols(13).Trim) > 600 Then
                            fncSCA2C5Check = True
                        End If
                    End If
                Case "80"
                    If CInt(selectedData.Symbols(7).Trim) > 700 Then
                        fncSCA2C5Check = True
                    End If

                    'バリエーション「B」を含む場合はS2もチェック
                    If selectedData.Symbols(1).IndexOf("B") >= 0 Then
                        If CInt(selectedData.Symbols(13).Trim) > 700 Then
                            fncSCA2C5Check = True
                        End If
                    End If
                Case "100"
                    If CInt(selectedData.Symbols(7).Trim) > 800 Then
                        fncSCA2C5Check = True
                    End If

                    'バリエーション「B」を含む場合はS2もチェック
                    If selectedData.Symbols(1).IndexOf("B") >= 0 Then
                        If CInt(selectedData.Symbols(13).Trim) > 800 Then
                            fncSCA2C5Check = True
                        End If
                    End If
            End Select
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncSCGC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
    ...
    '*                                      更新日：2010/02/22   更新者：Y.Miura
    '********************************************************************************************
    Private Function fncSCMC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Series.key_kataban
                ...
                Case "", "4", "F"
                    ...
                    '支持形式判定
                    If selectedData.Symbols(2).Trim = "LD" Then
                        If selectedData.Symbols(1).Trim <> "" Then
                            fncSCMC5Check = True
                        End If
                    End If
                    ...
                    For intLoopCnt = 0 To strOpArray.Length - 1
                        Select Case strOpArray(intLoopCnt).Trim
                            Case ""
                            Case "J", "K", "L"
                                If selectedData.Symbols(1).Trim = "Q" Then
                                    fncSCMC5Check = True
                                End If
                            Case "M"
                                If selectedData.Symbols(1).Trim = "Q" Then
                    ...
                    Select Case selectedData.Series.key_kataban
                        ...
                        Case Else
                            ...
                            '2013/06/19 修正
                            If selectedData.Series.key_kataban <> "4" Then
                                If selectedData.Symbols(16).Trim = "SX" Then
                                    fncSCMC5Check = True
                                End If
                            End If
                    End Select
                    ...
                    ' T2YDUスイッチの場合はC5(ただし販促価格)
                    If bolJudgeDiv Then
                        If selectedData.Symbols(9).Trim = "T2YDU" Then
                            fncSCMC5Check = True
                        End If
                    End If
                ...
                Case "B", "G"
                    ...
                    ' T2YDUスイッチの場合はC5(ただし販促価格)
                    If bolJudgeDiv Then
                        If selectedData.Symbols(7).Trim = "T2YDU" Or _
                           selectedData.Symbols(13).Trim = "T2YDU" Or _
                           selectedData.Symbols(7).Trim = "T3PH" Or _
                           selectedData.Symbols(13).Trim = "T3PH" Or _
                           selectedData.Symbols(7).Trim = "T3PV" Or _
                           selectedData.Symbols(13).Trim = "T3PV" Then
                            fncSCMC5Check = True
                        End If
                    End If
                    ...
                    Select Case selectedData.Series.key_kataban
                        ...
                        Case Else
                            'RM1306001 2013/06/04 追加
                            If selectedData.Symbols(20).Trim = "SX" Then
                                fncSCMC5Check = True
                            End If

                            'ロッド先端パターン判定
                            If selectedData.Symbols(19).Trim <> "" Then
                                fncSCMC5Check = True
                            End If
                    End Select
                ...
                Case "D", "H"
                    ...
                    Select Case selectedData.Series.key_kataban
                        ...
                        Case Else
                            ...
                            'RM1306001 2013/06/04 追加
                            If selectedData.Symbols(15).Trim = "SX" Then
                                fncSCMC5Check = True
                            End If
                    End Select
                    ...
                    If bolJudgeDiv Then
                        If selectedData.Symbols(8).Trim = "T2YDU" Or _
                            selectedData.Symbols(8).Trim = "T3PH" Or _
                            selectedData.Symbols(8).Trim = "T3PV" Then
                            fncSCMC5Check = True
                        End If
                    End If
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncSCSC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Symbols(3).Trim
                Case "125", "140", "160"
                    If CInt(selectedData.Symbols(12).Trim) > 800 Then
                        fncSCSC5Check = True
                    End If
                Case "180"
                    If CInt(selectedData.Symbols(12).Trim) > 900 Then
                        fncSCSC5Check = True
                    End If
                Case "200"
                    If CInt(selectedData.Symbols(12).Trim) > 1000 Then
                        fncSCSC5Check = True
                    End If
                Case "250"
                    If CInt(selectedData.Symbols(12).Trim) > 1200 Then
                        fncSCSC5Check = True
                    End If
            End Select
            ...
            If bolJudgeDiv Then
                If selectedData.Symbols(7).Trim = "T2YDUP" Or _
                   selectedData.Symbols(14).Trim = "T2YDUP" Then
                    fncSCSC5Check = True
                End If
            End If
    ...
    '*  <Boolean>
    '********************************************************************************************
    Private Function fncSCS2C5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncSSDC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
            ...
            Select Case selectedData.Series.key_kataban.Trim
                Case "", "4"
                    ...
                    For intLoopCnt = 0 To strOpArray.Length - 1
                        Select Case strOpArray(intLoopCnt).Trim
                            ...
                            Case "P6"
                                ...
                                Select Case True
                                    Case selectedData.Symbols(6).IndexOf("K") < 0 And _
                                         selectedData.Symbols(13).IndexOf("K") < 0
                                        'バリエーション判定
                                        Select Case selectedData.Symbols(1).Trim
                                            Case ""
                                            Case Else
                                        ...
                                        Select Case selectedData.Symbols(4).Trim
                                            Case "125", "140", "160"
                                                fncSSDC5Check = True
                                        End Select
                                    Case selectedData.Symbols(6).IndexOf("K") >= 0 Or _
                                         selectedData.Symbols(13).IndexOf("K") >= 0
                                        fncSSDC5Check = True
                                End Select
                            Case "P5", "P51"
                                ...
                                'オプション判定
                                If selectedData.Symbols(19).IndexOf("A2") >= 0 Then
                                    fncSSDC5Check = True
                                End If
                            Case "P7", "P71"
                                'バリエーション判定
                    ...
                    If bolJudgeDiv Then
                        ...
                        'If selectedData.Symbols(9).Trim = "T2YDU" Or _
                        '   selectedData.Symbols(16).Trim = "T2YDU" Then
                        '    fncSSDC5Check = True
                        'End If
                        Select Case selectedData.Symbols(9).Trim
                ...
                Case "D", "E"
                    ...
                    Select Case selectedData.Symbols(1).Trim
                        Case "D", "DG1", "DG4"
                            ...
                            Select Case selectedData.Symbols(4).Trim
                                Case "12", "16", "20"
                                    'ストローク判定
                                    If CInt(selectedData.Symbols(6).Trim) >= 31 Then
                                        fncSSDC5Check = True
                                    End If
                                Case "25", "32", "40", "50", "63", _
                                     "80", "100"
                                    'ストローク判定
                                    If CInt(selectedData.Symbols(6).Trim) >= 51 Then
                                        fncSSDC5Check = True
                                    End If
                            End Select
                    End Select
                    ...
                    If bolJudgeDiv Then
                        'RM0912XXX 2009/12/09 Y.Miura　二次電池C5加算対応
                        'If selectedData.Symbols(8).Trim = "T2YDU" Then
                        '    fncSSDC5Check = True
                        'End If
                    ...
                    'RM1306001 2013/06/04 追加
                    '2013/06/19　修正
                    If selectedData.Series.key_kataban = "D" Then
                        If selectedData.Symbols(14).Trim = "SX" Then
                            fncSSDC5Check = True
                        End If
                    End If
                Case "K", "P"
                            ...
                            Select Case selectedData.Symbols(4).Trim
                                Case "20"
                                    ...
                                    If selectedData.Symbols(7).Trim <> "" Then
                                        If CInt(selectedData.Symbols(7).Trim) >= 101 Then
                                            fncSSDC5Check = True
                                        End If
                                    End If

                                    'S2ストローク判定
                                    If CInt(selectedData.Symbols(13).Trim) >= 101 Then
                                        fncSSDC5Check = True
                                    End If
                                Case "25", "32", "40", "50"
                                    'S1ストローク判定
                                    If selectedData.Symbols(7).Trim <> "" Then
                                        If CInt(selectedData.Symbols(7).Trim) >= 151 Then
                                            fncSSDC5Check = True
                                        End If
                                    End If

                                    'S2ストローク判定
                                    If CInt(selectedData.Symbols(13).Trim) >= 151 Then
                                        fncSSDC5Check = True
                                    End If
                                Case "63", "80", "100"
                                    'S1ストローク判定
                                    If selectedData.Symbols(7).Trim <> "" Then
                                        If CInt(selectedData.Symbols(7).Trim) >= 201 Then
                                            fncSSDC5Check = True
                                        End If
                                    End If

                                    'S2ストローク判定
                                    If CInt(selectedData.Symbols(13).Trim) >= 201 Then
                                        fncSSDC5Check = True
                                    End If
                            End Select
                    End Select
                    ...
                    For intLoopCnt = 0 To strOpArray.Length - 1
                        Select Case strOpArray(intLoopCnt).Trim
                            ...
                            Case "P6"
                                ...
                                'オプション判定
                                If selectedData.Symbols(17).IndexOf("M") >= 0 Then
                                    fncSSDC5Check = True
                                End If
                            ...
                            Case "P5", "P51"
                                ...
                                'オプション判定
                                If selectedData.Symbols(17).IndexOf("A2") >= 0 Then
                                    fncSSDC5Check = True
                                End If
                            Case "P7", "P71", "P12"
                                'バリエーション判定
                    ...
                    If bolJudgeDiv Then
                        'RM0912XXX 2009/12/09 Y.Miura　二次電池C5加算対応
                        'If selectedData.Symbols(8).Trim = "T2YDU" Or _
                        '   selectedData.Symbols(14).Trim = "T2YDU" Then
                        '    fncSSDC5Check = True
                        'End If
                    ...
                    'RM1306001 2013/06/04 追加
                    '2013/06/19 修正
                    If selectedData.Series.key_kataban = "K" Then
                        If selectedData.Symbols(20).Trim = "SX" Then
                            fncSSDC5Check = True
                        End If
                    End If
                    ...
                    Select Case selectedData.Series.key_kataban
                        Case "R", "S"
                            If selectedData.Symbols(21).Trim = "S040" Or _
                        selectedData.Symbols(21).Trim = "S050" Then
                                fncSSDC5Check = False
                            End If
                    End Select
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncSTGC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            'バリエーション判定
            'If InStr(selectedData.Symbols(1).Trim, "G5") <> 0 Or _
            '   InStr(selectedData.Symbols(1).Trim, "T2") <> 0 Then
            '    fncSTGC5Check = True
            'End If
            Select Case selectedData.Symbols(1).Trim
                Case "G5", "T2"
                    fncSTGC5Check = True
                Case "C", "G", "G1"
                    If selectedData.Symbols(9).Trim = "P4" Or _
                       selectedData.Symbols(9).Trim = "P40" Then
                        fncSTGC5Check = True
                    End If
            End Select
            ...
            'オプション判定
            If InStr(selectedData.Symbols(9).Trim, "O") <> 0 Then
                fncSTGC5Check = True
            End If
            If InStr(selectedData.Symbols(9).Trim, "P6") <> 0 Then
                Select Case selectedData.Series.series_kataban.Trim
                    Case "STG-M", "STG-B"
                        If selectedData.Symbols(1).Trim = "C" Or _
                           selectedData.Symbols(3).Trim = "C" Then
                            fncSTGC5Check = True
                        End If
                End Select
            End If
            ...
            Select Case selectedData.Series.series_kataban.Trim
                Case "STG-M", "STG-B"
                    ...
                    If selectedData.Series.key_kataban = "" Then
                        If InStr(selectedData.Symbols(10).Trim, "SX") <> 0 Then
                            fncSTGC5Check = True
                        End If
                    End If
            End Select
            ...
            Select Case selectedData.Series.key_kataban
                Case "R", "S"
                    If selectedData.Symbols(11).Trim = "S040" Or _
                selectedData.Symbols(11).Trim = "S050" Then
                        fncSTGC5Check = False
                    End If
            End Select
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncSTSC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            Select Case selectedData.Symbols(3).Trim
                Case "100"
                    'オプションによる判定
                    If selectedData.Symbols(12).IndexOf("O") >= 0 Or _
                       selectedData.Symbols(12).IndexOf("P52") >= 0 Or _
                       selectedData.Symbols(12).IndexOf("P53") >= 0 Or _
                       selectedData.Symbols(12).IndexOf("P72") >= 0 Or _
                       selectedData.Symbols(12).IndexOf("P73") >= 0 Then
                        fncSTSC5Check = True
                    End If
            End Select
            ...
            For intLoopCnt = 0 To strOpArray.Length - 1
                Select Case strOpArray(intLoopCnt).Trim
                    ...
                    Case "P52", "P53"
                        ...
                        'オプション判定
                        If selectedData.Symbols(1).IndexOf("M") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("M1") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("F") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("O") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("P6") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("P72") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("P73") >= 0 Or _
                           selectedData.Symbols(1).IndexOf("E") >= 0 Then
                            fncSTSC5Check = True
                        End If
                    Case "M", "M1", "P6", "E"
                        'バリエーション判定
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncLCGC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            If selectedData.Series.key_kataban = "1" Then
                If selectedData.Symbols(13).Trim = "SX" Then
                    fncLCGC5Check = True
                End If
            End If
    ...
    '********************************************************************************************
    Private Function fncLCRC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            'スイッチ   
            If selectedData.Symbols(5).Trim = "F3PH" Or _
                selectedData.Symbols(5).Trim = "F3PV" Or _
                selectedData.Symbols(5).Trim = "T3PH" Or _
                selectedData.Symbols(5).Trim = "T3PV" Then
                fncLCRC5Check = True
            End If
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncSSGC5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
    ...
    '********************************************************************************************
    Private Function fncJSK2C5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            ' ストローク判定
            If CInt(selectedData.Symbols(3).Trim) > 700 Then
                fncJSK2C5Check = True
            End If

            If selectedData.Series.series_kataban.Trim = "JSK2-V" Then
                If selectedData.Symbols(5).Trim = "T3PH" Or _
                selectedData.Symbols(5).Trim = "T3PV" Then
                    fncJSK2C5Check = True
                End If
    ...
    '********************************************************************************************
    Private Function fncSRL3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            '2013/06/19 修正
            If selectedData.Series.key_kataban = "" Then
                If selectedData.Symbols(11).Trim = "SX" Then
                    fncSRL3C5Check = True
                End If
            End If
    ...
    '*                                          作成日：2008/01/08      作成者：NII A.Takahashi
    '********************************************************************************************
    Private Function fncSSD2C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
            ...
            If bolJudgeDiv Then
                Select Case selectedData.Series.key_kataban.Trim
                    ...
                    Case ""
                        ...
                        'オプション
                        Dim strOpArray() As String
                        strOpArray = Split(selectedData.Symbols(19).Trim, mycontrolchars.comma)
                    ...
                    Case "6", "E"
                        ...
                        'オプション
                        Dim strOpArray() As String
                        strOpArray = Split(selectedData.Symbols(9).Trim, mycontrolchars.comma)
                        For intLoopCnt As Integer = 0 To strOpArray.Length - 1
                            Select Case strOpArray(intLoopCnt).Trim
                                Case "P4", "P40"
                                    fncSSD2C5Check = True
    ...
    '********************************************************************************************
    Private Function fncSRT3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
    ...
    '********************************************************************************************
    Private Function fncSRG3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            'RM1306001 2013/06/04 追加
            If selectedData.Symbols(10).Trim = "SX" Then
                fncSRG3C5Check = True
            End If
    ...
    '*                           販売促進価格を適用して表示のみを『３（Ｃ５）』にする
    '********************************************************************************************
    Private Function fncUCAC2C5Check(selectedData As SelectedInfo,
                                   Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            If selectedData.Symbols.Count > 8 Then
                Select Case selectedData.Symbols(8)
                    Case "T2YDU", "T3PH", "T3PV"
                        If bolJudgeDiv Then
                            fncUCAC2C5Check = True
                        End If
            ...
            Select Case selectedData.Series.key_kataban
                Case "R", "S"
                    If selectedData.Symbols(14).Trim = "S040" Or _
                selectedData.Symbols(14).Trim = "S050" Then
                        fncUCAC2C5Check = False
                    End If
            End Select
    ...
    '*                                          更新日：2009/09/04      更新者：Y.Miura
    '********************************************************************************************
    Private Function fncLiIonC5Check(selectedData As SelectedInfo,
    ...
    '*                                          作成日：2013/06/04      
    '********************************************************************************************
    Private Function fncMRL2C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
    ...
    '*                                          作成日：2013/06/04      
    '********************************************************************************************
    Private Function fncSRM3C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            '2013/06/19 修正
            If selectedData.Series.key_kataban.Trim = "" Then
                If selectedData.Symbols(9).Trim = "SX" Then
                    fncSRM3C5Check = True
                End If
            End If
    ...
    '*                                          作成日：2013/06/04      
    '********************************************************************************************
    Private Function fncUCA2C5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
        ...
        Try
            ...
            '2013/06/19 修正
            If selectedData.Series.key_kataban.Trim = "" Then
                If selectedData.Symbols(5).Trim = "SX" Then
                    fncUCA2C5Check = True
                End If
            End If

            If selectedData.Series.series_kataban.Trim = "UCA2-L" Or _
                selectedData.Series.series_kataban.Trim = "UCA2-BL" Then
                If selectedData.Series.key_kataban.Trim = "" Then
                    If selectedData.Symbols(4).Trim = "T3PH" Or _
                       selectedData.Symbols(4).Trim = "T3PV" Then
                        fncUCA2C5Check = True
    ...
    '*                                          作成日：2013/06/04      
    '********************************************************************************************
    Private Function fncNCKC5Check(selectedData As SelectedInfo,
                                    Optional ByVal bolJudgeDiv As Boolean = True) As Boolean
